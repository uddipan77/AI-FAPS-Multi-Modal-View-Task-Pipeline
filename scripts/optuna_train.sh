...
#SBATCH --job-name=optuna_densenet_rescnn             # Job name
#SBATCH --output=/home/hpc/iwfa/iwfa110h/Uddipan/AI-FAPS_Vishnudev_Krishnadas/logs/optuna/rescnn/optuna_train_rescnn_dense_121.out  # Output log file
#SBATCH --error=/home/hpc/iwfa/iwfa110h/Uddipan/AI-FAPS_Vishnudev_Krishnadas/logs/optuna/rescnn/optuna_train_rescnn_dense_121.err   # Error log file
...
python src/train_optuna.py \
  --config configs/hyperparameter_search/optuna_train.yaml \
  --n_trials 75 \
  --study_name multimodal_multiview_multitask_densenet_RESCNN_withpruner \
