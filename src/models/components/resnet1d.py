...
class ResNet1D(nn.Module):
    def __init__(self, layers: List[int], input_channels: int, num_classes: int, input_size: int):
        super().__init__()
        self.input_size = input_size  # Now explicitly using input_size for potential layer adjustments
        self.in_channels = 64
